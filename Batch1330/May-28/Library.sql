drop database if exists librarysonix;

create database librarysonix;
...
Insert into LibUsers values('Chandra','Sekhar'),('Sai','Sampath'),
('Anil','Varma'),('Manohar','Dukkola'),('Sushma','Sushma');