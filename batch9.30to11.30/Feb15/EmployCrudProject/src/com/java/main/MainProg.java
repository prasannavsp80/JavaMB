...
public class MainProg {
	...
	public static void readFileMain() throws FileNotFoundException, ClassNotFoundException, IOException {
		System.out.println(bal.readFileBal());
	}
	
	public static void writeFileMain() throws FileNotFoundException, IOException {
		System.out.println(bal.writeFileBal());
	}
